...
def main():
    ...
    parser.add_argument('invested', metavar='invested', type=int, help='Mem€ investite in post.')
    ...
    plt.ylabel('Return / Mem€',fontsize='14')
    plt.plot(x,y,label='Return curve')
    plt.plot(x2,y2,label='Meme Performance',color='r')
    plt.plot(args.u_final, inv_return, color='r', marker='X', markersize=8, linestyle='none', label='Return: %i Mem€ (Profit: %i Mem€)' %(inv_return,profit))
